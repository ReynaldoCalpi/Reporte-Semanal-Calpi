...
def cargar_datos():
    ...
    df = conn.read(spreadsheet="# Cambia tu línea 88 por esta:
df = conn.read(spreadsheet="https://docs.google.com/spreadsheets/d/1ozc9yAbVZ3vEhjJEOuQd2D14vhFd7JFSf6D8Jr2R-OQ/edit", worksheet="DATA")", worksheet="DATA")
    return df
